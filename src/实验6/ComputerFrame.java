...
public class ComputerFrame extends JFrame {
    ...
    ComputerFrame() {
        ...
        textOne = new JTextField(5);  //【代码 1】创建 textOne,其可见字符长是 5
        ...
        getProblem.addActionListener(teacherZhang); //【代码 2】将 teacherZhang 注册为 getProblem 的 ActionEvent 事件监视器
        giveAnwser.addActionListener(teacherZhang); //【代码 3】将 teacherZhang 注册为 giveAnwser 的 ActionEvent 事件监视器
        textResult.addActionListener(teacherZhang); //【代码 4】将 teacherZhang 注册为 textResult 的 ActionEvent 事件监视器
